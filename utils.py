...
def print_clustering_scores(labels_true,labels_pred):
    ...
    """
    print("Homogeneity: %0.4f" % metrics.homogeneity_score(labels_true, labels_pred))
    print("Completeness: %0.4f" % metrics.completeness_score(labels_true, labels_pred))
    print("V-measure: %0.4f" % metrics.v_measure_score(labels_true, labels_pred))
    print("Adjusted Rand Index: %0.4f"
        % metrics.adjusted_rand_score(labels_true, labels_pred))
    print("Adjusted Mutual Information: %0.4f"
        % metrics.adjusted_mutual_info_score(labels_true, labels_pred,
                                            average_method='arithmetic'))
    print("Fowlkes and Mallows Index: %0.4f" % metrics.fowlkes_mallows_score(labels_true,labels_pred))
